...
exports.statusToString[interfaces.TestcaseResultType.WrongAnswer] =
    'Wrong Answer';
exports.statusToString[interfaces.TestcaseResultType.PartiallyCorrect] =
    'Partially Correct';
exports.statusToString[interfaces.TestcaseResultType.MemoryLimitExceeded] =
    'Memory Limit Exceeded';
exports.statusToString[interfaces.TestcaseResultType.TimeLimitExceeded] =
    'Time Limit Exceeded';
exports.statusToString[interfaces.TestcaseResultType.OutputLimitExceeded] =
    'Output Limit Exceeded';
exports.statusToString[interfaces.TestcaseResultType.RuntimeError] =
    'Runtime Error';
exports.statusToString[interfaces.TestcaseResultType.FileError] = 'File Error';
exports.statusToString[interfaces.TestcaseResultType.JudgementFailed] =
    'Judgement Failed';
exports.statusToString[interfaces.TestcaseResultType.InvalidInteraction] =
    'Invalid Interaction';
...
function convertResult(taskId, source) {
    ...
    if (
        source.compile &&
        source.compile.status === interfaces.TaskStatus.Failed
    ) {
