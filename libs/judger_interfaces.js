...
(function (TestcaseResultType) {
    ...
    TestcaseResultType[(TestcaseResultType['PartiallyCorrect'] = 3)] =
        'PartiallyCorrect';
    TestcaseResultType[(TestcaseResultType['MemoryLimitExceeded'] = 4)] =
        'MemoryLimitExceeded';
    TestcaseResultType[(TestcaseResultType['TimeLimitExceeded'] = 5)] =
        'TimeLimitExceeded';
    TestcaseResultType[(TestcaseResultType['OutputLimitExceeded'] = 6)] =
        'OutputLimitExceeded';
    TestcaseResultType[(TestcaseResultType['FileError'] = 7)] = 'FileError';
    TestcaseResultType[(TestcaseResultType['RuntimeError'] = 8)] =
        'RuntimeError';
    TestcaseResultType[(TestcaseResultType['JudgementFailed'] = 9)] =
        'JudgementFailed';
    TestcaseResultType[(TestcaseResultType['InvalidInteraction'] = 10)] =
        'InvalidInteraction';
})(
    (TestcaseResultType =
